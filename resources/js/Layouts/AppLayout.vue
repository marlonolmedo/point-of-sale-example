...
import DropdownLinkSideBar from '@/Components/DropDownLinkSideBar.vue';
                ...
                <nav class="mt-10">
                    ...
                    <!-- <div class="relative">
                        ...
                        <label for="dropdown-toggle"
                            class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 cursor-pointer">
                            More Options
                        </label>
                        <div class="bg-gray-700 mt-1 rounded-md shadow-lg absolute w-full z-10 hidden">
                            <a class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600" href="#">
                                Option 1
                            </a>
                            <a class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-600" href="#">
